...
public class IObligatorioJuegoDePruebaTest {

    private Sistema sistema;

    public IObligatorioJuegoDePruebaTest() {
        sistema = new Sistema();
    }
    ...
    public void testRegistrarSala() {
        ...
        Retorno ret2 = sistema.registrarSala("Sala B", 10);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
    }
    ...
    public void testRegistrarSala_ERROR2() {
        ...
        Retorno ret2 = sistema.registrarSala("Sala B", 0);
        assertEquals(Retorno.Resultado.ERROR_2, ret2.resultado);

        Retorno ret3 = sistema.registrarSala("Sala B", -10);
    ...
    public void testRegistrarEvento() {
        ...
        Retorno ret2 = sistema.registrarEvento("EVT01", "Concierto", 80, fecha);
        assertEquals(Retorno.Resultado.OK, ret.resultado);
    }
